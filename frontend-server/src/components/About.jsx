            ...
            <div className="container py-5 my-5">
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <p className="lead mb-4" style={{ color: 'grey', fontFamily: 'Arial, sans-serif', fontSize: '18px', fontWeight: 'bold', lineHeight: '1.6' }}>
                        ...
                        <NavLink to="/contact" className="btn btn-outline-primary px-3">Buy Tokens</NavLink>
                    </div>
